...
class Players(Base):
    ...
    turn_order: Mapped[int] = mapped_column(nullable=True)
...
class Boards(Base):
    ...
    current_player_turn = Column(Integer, ForeignKey('players.id'), nullable=True)
    next_player_turn = Column(Integer, ForeignKey('players.id'), nullable=True)
