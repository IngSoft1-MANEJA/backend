...
def test_validate_figures():
    ...
    assert validate_inverse_diagonal(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=2, columnIndex=1))
    assert validate_inverse_diagonal(Tile(rowIndex=2, columnIndex=1), Tile(rowIndex=0, columnIndex=0))
    assert validate_inverse_diagonal(Tile(rowIndex=1, columnIndex=2), Tile(rowIndex=3, columnIndex=3))
    assert validate_inverse_diagonal(Tile(rowIndex=3, columnIndex=3), Tile(rowIndex=1, columnIndex=2))
    assert validate_inverse_diagonal(Tile(rowIndex=2, columnIndex=1), Tile(rowIndex=0, columnIndex=0))
    assert validate_inverse_diagonal(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=2, columnIndex=1))
    assert validate_inverse_diagonal(Tile(rowIndex=3, columnIndex=3), Tile(rowIndex=1, columnIndex=2))
    assert validate_inverse_diagonal(Tile(rowIndex=1, columnIndex=2), Tile(rowIndex=3, columnIndex=3))
    
    assert not validate_inverse_diagonal(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=1, columnIndex=1))
    assert not validate_inverse_diagonal(Tile(rowIndex=1, columnIndex=1), Tile(rowIndex=2, columnIndex=2))
    assert not validate_inverse_diagonal(Tile(rowIndex=2, columnIndex=2), Tile(rowIndex=4, columnIndex=4))
    assert not validate_inverse_diagonal(Tile(rowIndex=3, columnIndex=3), Tile(rowIndex=5, columnIndex=5))
    ...
    assert validate_line_border(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=0, columnIndex=3))
    assert validate_line_border(Tile(rowIndex=0, columnIndex=3), Tile(rowIndex=0, columnIndex=0))
    assert validate_line_border(Tile(rowIndex=1, columnIndex=1), Tile(rowIndex=1, columnIndex=4))
    assert validate_line_border(Tile(rowIndex=1, columnIndex=4), Tile(rowIndex=1, columnIndex=1))
    assert validate_line_border(Tile(rowIndex=2, columnIndex=2), Tile(rowIndex=5, columnIndex=2))
    assert validate_line_border(Tile(rowIndex=5, columnIndex=2), Tile(rowIndex=2, columnIndex=2))
    assert validate_line_border(Tile(rowIndex=3, columnIndex=3), Tile(rowIndex=3, columnIndex=0))
    assert validate_line_border(Tile(rowIndex=3, columnIndex=0), Tile(rowIndex=3, columnIndex=3))
    
    assert not validate_line_border(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=0, columnIndex=2))
    assert not validate_line_border(Tile(rowIndex=0, columnIndex=0), Tile(rowIndex=1, columnIndex=3))
    assert not validate_line_border(Tile(rowIndex=1, columnIndex=1), Tile(rowIndex=4, columnIndex=4))
    assert not validate_line_border(Tile(rowIndex=2, columnIndex=2), Tile(rowIndex=6, columnIndex=2))
    assert not validate_line_border(Tile(rowIndex=3, columnIndex=3), Tile(rowIndex=3, columnIndex=4))
